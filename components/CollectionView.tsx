...
const CollectionView: React.FC = () => {
  ...
  // Increased radius to accommodate larger images
  const radius = 850;
  ...
  return (
    ...
    >
          ...
          >
            <div className="relative w-full h-full overflow-hidden transition-all duration-700 group-hover:scale-110">
              <img 
                src={p.photo.url} 
                alt={p.photo.title}
                className="w-full h-full object-cover grayscale-[0.5] opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700"
                style={{
                  // Reduced radial fade for clearer images
      ...
      <div className="absolute top-12 left-12 pointer-events-none">
        ...
        <p className="text-[9px] uppercase tracking-[0.4em] text-neutral-500">Exploration of Fragmentary Records</p>
      </div>
